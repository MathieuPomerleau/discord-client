...
{
    public class PagedListEmbedContentTests
    {
        private static readonly IFixture Fixture = new Fixture();
        private PagedListEmbedContent _subject;
        ...
        public void Get_WithSamePages_ThenReturnsSameEmbedBuilder()
        {
            ...
            _subject = new PagedListEmbedContent(_fieldsPerPage, fields, _embedBuilder);
        ...
        private static IList<InjhinuityEmbedField> GetOnePageFields() =>
            new[] { Fixture.Create<InjhinuityEmbedField>(), Fixture.Create<InjhinuityEmbedField>() };

        private static IList<InjhinuityEmbedField> GetThreePageFields() =>
